...
from promptflow.utils import InMemoryCache, FileCache, hash_prompt
...
def test_hash_prompt():
    ...
    assert hash_prompt(prompt1, include_parameters=False) == hash_prompt(prompt2, include_parameters=False)

...
class PromptTemplate(BaseModel):
    ...
    def to_prompt(self, role: Union[str, MessageRole] = MessageRole.USER, require_user_message: bool = True, **kwargs) -> Prompt:
        """
...
class MultiMessageTemplate(BaseModel):
    ...
    def render(self, **kwargs) -> List[Dict[str, str]]:
        ...
        for i in range(max_len):
            ...
            if i < len(self.assistant_templates):
                ...
                messages.append({
                    "role": "assistant",
                    "content": assistant_template.render(**variables)
                })
    ...
    @classmethod
    def from_file(cls, file_path: str, delimiter: str = "---") -> "MultiMessageTemplate":
        """
